...
- Deliver a clean, branded, user-friendly report to key stakeholders
...
3. How do different departments and job roles perform?
4. What is the current attrition rate and what factors contribute to it?
5. Which factors have the most significant impact on employee retention?
6. What actions should Atlas Labs take to retain more employees?
...
**Format:** CSV files  
**Grain:** Individual employee records  

**Key Fields:**
- Employee ID, Name, Age, Gender
- Department, Job Role, Hire Date
...
- Total employee count and active headcount
- Current attrition rate KPI
- Hiring trends over time (line chart)
- Department distribution (bar chart)

<p  align="center"><img width="80%" src="https://github.com/SatyamSingh1299/HR_Analytics_PowerBI/blob/main/images/img1.png" /></a></p> 
...
<p  align="center"><img width="80%" src="https://github.com/SatyamSingh1299/HR_Analytics_PowerBI/blob/main/images/img2.png" /></a></p>
...
<p  align="center"><img width="80%" src="https://github.com/SatyamSingh1299/HR_Analytics_PowerBI/blob/main/images/img3.png" /></a></p>

### 4. Attrition Insights
- Attrition rate by department and job role
- Factors impacting attrition (age, tenure, salary, performance)
